  ...
  return (
    <div className="h-screen w-full flex justify-center items-center bg-gradient-to-br from-white via-gray-100 to-gray-200 dark:from-zinc-900 dark:via-zinc-800 dark:to-zinc-700 px-4">
      ...
      >
        ...
        {/* Μήνυμα */}
        <h2 className="text-xl sm:text-2xl font-bold text-gray-800 dark:text-white text-center tracking-tight">
          Ετοιμάζουμε τη σελίδα σας...
        </h2>

        <p className="text-sm text-gray-500 dark:text-zinc-300 text-center max-w-xs">
          Το Yummy συνδέεται με το εστιατόριό σας. Παρακαλώ περιμένετε.
        </p>
      </motion.div>
    </div>
  );
